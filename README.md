...
In OAuth flows, an access token obtained to authorize API calls, and you may get their user profile information from the provider's userinfo endpoint.
In OIDC flows, a cryptographically signed ID token authenticates the user.
