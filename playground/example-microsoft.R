...
#   needed for browser cookie. But Shiny only redirects to
#   '127.0.0.1' & blocks process once running, so we use later::later()
#   to open the browser with 'utils::browseURL()' to localhost:8100
