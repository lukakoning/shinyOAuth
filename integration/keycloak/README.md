...
- `test_integration_keycloak_jar_unhappy.R` — JAR unhappy-path coverage against live Keycloak, exercising request-object audience rejection both at the authorization endpoint and through PAR.
