...
for (index in seq_len(nrow(cases))) {
  ...
  testthat::test_that(paste("retained refresh scope narrowing", response_mode, async), {
    ...
    retention_browser_click(browser, "write_a")
    retention_browser_result(browser, "a:written")
    ...
    retention_browser_result(browser, "unavailable")
    retention_browser_click(browser, "read_a")
    retention_browser_result(browser, "a:3")
    ...
    retention_browser_click(browser, "write_b")
    retention_browser_result(browser, "b:written")
