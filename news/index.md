...
- The Globus preset supports OIDC login with RS512 signatures.
  Additional resource-server tokens remain available through
  `OAuthToken@extra_fields`; automatic management of Globus
  multi-resource grants is not included.
