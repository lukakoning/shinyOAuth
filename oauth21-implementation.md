...
evidence. Another agent is working in this checkout; each implementation
...
2.  WP1: compose authorization endpoint queries without ambiguous
    managed fields.
3.  WP2: reject competing access-token transports in resource request
    builders.
...
7.  WP5b: centralize callback capacity and increase the default code
    budget.
...
To be filled with actual completed checks, revisions and unavailable
coverage.
