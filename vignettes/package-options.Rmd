...
- `options(shinyOAuth.allow_legacy_introspection_active = TRUE)` – opt in to
  numeric/string coercion of nonstandard introspection `active` values. Default
  `FALSE`: RFC 7662 responses must contain a JSON boolean. Enable only for a
  provider whose legacy response contract you have verified.
