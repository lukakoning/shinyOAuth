...
This package is also compatible with OpenTelemetry (emitting traces,
metrics, and logs, compatible with various observability platforms).
See `vignette("opentelemetry", package = "shinyOAuth")` for guidance 
on how to set this up. All audit events here are also emitted as OpenTelemetry logs.
...
This reduces the risk of correlation or dictionary reidentification if logs leak.
