...
The function you reigster should be fast, non-blocking, and never throw errors.
...
- Context: `provider`, `issuer`, `client_id_digest`, `phase` (`sync_token_exchange`|`async_token_exchange`), `error_class`, `mirai_error_type`
