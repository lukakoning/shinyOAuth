...
field are not preserved verbatim in the OTel log payload; instead, shinyOAuth
exports derived scalar session/request attributes such as async/process ids,
the digested Shiny session token, and selected HTTP request metadata.
