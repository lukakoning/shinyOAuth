...
obviously invalid callbacks, stores the accepted callback payload under a
short-lived single-use handle, and replies with a `303 See Other` redirect back
to the app. The redirected URL no longer carries raw OAuth callback values;
