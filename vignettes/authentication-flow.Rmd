...
return the authorization response as an HTTP POST. If `response_mode` is left
unset, 'shinyOAuth' stays on the normal query callback flow and does not send a
...
values such as `form_post.jwt` are not.
