...
For encrypted JARM on a shared route, supply an outer `iss` that matches the
decrypted issuer, or use distinct routes. Issuer routing never replaces signature,
