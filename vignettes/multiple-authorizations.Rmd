...
provisional pool with the same limit; its oldest entries may be replaced and
expire after at most five minutes. A browser remains provisional during its first
authorization until the connection is accepted. Account entries include logged-out
