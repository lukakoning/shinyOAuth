...
These functions configure access and make authenticated FHIR requests:

| Step | shinyOAuth interface |
| --- | --- |
| Read a configured server's SMART metadata | `smart_discover()` |
| Combine it with your registered app's settings | `smart_client()`, returning an `OAuthClient` |
