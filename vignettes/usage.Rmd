...
- `request` stays blocked by default because shinyOAuth does not automatically build RFC 9101
  Request Object JWTs; leave it reserved unless you are intentionally taking responsibility for
  a fully custom advanced flow.
