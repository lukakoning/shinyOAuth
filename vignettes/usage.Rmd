...
These options control the amount of information printed to the console when errors occur.
Intended primarily for debugging during development, not for users of the package.
