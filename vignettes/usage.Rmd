...
For OpenTelemetry instrumentation (traces, metrics, logs), see:
...
audit and trace hooks. For observability via OpenTelemetry (traces,
metrics, logs), see `vignette("opentelemetry", package = "shinyOAuth")`.
