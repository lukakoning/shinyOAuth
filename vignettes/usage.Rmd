...
- If one app can interact with multiple authorization servers, either give each issuer a distinct `redirect_uri` or set `require_callback_issuer = TRUE` for issuer-configured clients so callbacks without RFC 9207 `iss` are rejected before token exchange
