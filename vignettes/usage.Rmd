...
to the app after the user authenticates. The default is `response_mode = "query"`,
which means the provider will redirect back to the app with query parameters 
(e.g., `?code=...&state=...`).
