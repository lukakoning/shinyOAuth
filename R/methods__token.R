...
#'     thumbprint so later mTLS requests keep their sender-constraint routing,
#'     but that preserved thumbprint is continuity state rather than fresh
#'     proof for the new token
#'
