...
When DPoP responses return `DPoP-Nonce` on success, shinyOAuth now remembers
and reuses that nonce on the next DPoP request to the same origin instead of
waiting for another nonce challenge.
